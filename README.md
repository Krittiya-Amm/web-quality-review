...
```
ตรวจเว็บนี้ https://example.com
```
แค่นี้พอ — ไม่ต้องเติม "ก่อนส่งลูกค้า" หรือ "ก่อน merge" เพราะจุดประสงค์ของรอบตรวจกำหนดตอนตอบคำถาม **Track** ในขั้นถัดไปอยู่แล้ว

หรือพิมพ์ `/web-quality-review` เรียกตรงๆ · ประโยคอื่นที่เรียกติด: "ตรวจหน้านี้", "ตรวจงานเว็บ", "ตรวจก่อนส่งลูกค้า", "ตรวจก่อน merge", "QA เว็บ", "รีวิวคุณภาพเว็บ", "เช็คความพร้อมก่อน handoff", "ตรวจ responsive / accessibility / SEO"
